...
const Dashboard = () => {
  ...
  return (
    <div className="p-4 max-w-full mx-auto text-blue-500">
      <Toaster />
      ...
      <form onSubmit={handleSubmit} className="flex justify-center items-center w-full gap-5">
        ...
        <Button
          type="submit"
          variant="outline"
          className="text-blue-500 border-blue-400 hover:bg-blue-500 hover:text-white"
        >
          Submit
        </Button>
      </form>
              ...
              <tr key={user._id}>
                ...
                <td className="border p-2 flex gap-2">
                  {editingUser === user._id ? (
                    ...
                    <>
                      <FaPen
                        className="cursor-pointer text-2xl ml-2 text-green-500"
